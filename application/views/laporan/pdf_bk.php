    ...
    <body>
        ...
        <div class="invoice-box">
            ...
            <table cellpadding="0" cellspacing="0">
                ...
                $nama_anggota = $this->Mglobals->getAllQR("SELECT nama FROM anggota where idanggota = '".$row->idanggota."';")->nama;
                    ?>
                <tr>
                    <td style="text-align: center;"><?php echo $row->idbk; ?></td>
                    <td style="text-align: center;"><?php echo $row->tanggal; ?></td>
                    <td style="text-align: center;"><?php echo $nama_anggota; ?></td>
                    <td>
                        <table cellpadding="0" cellspacing="0">
                            <tr class="heading">
